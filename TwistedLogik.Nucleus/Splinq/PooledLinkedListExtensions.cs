...
namespace TwistedLogik.Nucleus.Splinq
{
    ...
    public static class PooledLinkedListExtensions
    {
        ...
        /// <param name="source">The <see cref="PooledLinkedList{T}"/> to evaluate.</param>
        /// <returns><see langword="true"/> if the source list contains any elements; otherwise, <see langword="false"/>.</returns>
        public static Boolean Any<T>(this PooledLinkedList<T> source)
        {
        ...
        /// <returns><see langword="true"/> if the source list contains any elements; otherwise, <see langword="false"/>.</returns>
        public static Boolean Any<T>(this PooledLinkedList<T> source, Predicate<T> predicate)
        {
            Contract.Require(source, "source");
        ...
        public static Boolean All<T>(this PooledLinkedList<T> source, Predicate<T> predicate)
        {
            Contract.Require(source, "source");
            Contract.Require(predicate, "predicate");
        ...
        public static Int32 Count<T>(this PooledLinkedList<T> source)
        {
            Contract.Require(source, "source");
        ...
        /// <param name="predicate">The predicate against which to evaluate the items of <paramref name="source"/>.</param>
        /// <returns>The number of items in the source list.</returns>
        public static Int32 Count<T>(this PooledLinkedList<T> source, Predicate<T> predicate)
        {
            Contract.Require(source, "source");
            Contract.Require(predicate, "predicate");
        ...
        public static T First<T>(this PooledLinkedList<T> source)
        {
            Contract.Require(source, "source");
        ...
        public static T First<T>(this PooledLinkedList<T> source, Predicate<T> predicate)
        {
            Contract.Require(source, "source");
            Contract.Require(predicate, "predicate");
        ...
        public static T Last<T>(this PooledLinkedList<T> source)
        {
            Contract.Require(source, "source");
        ...
        public static T Last<T>(this PooledLinkedList<T> source, Predicate<T> predicate)
        {
            Contract.Require(source, "source");
            Contract.Require(predicate, "predicate");
        ...
        public static T Single<T>(this PooledLinkedList<T> source)
        {
            Contract.Require(source, "source");
        ...
        public static T Single<T>(this PooledLinkedList<T> source, Predicate<T> predicate)
        {
            Contract.Require(source, "source");
            Contract.Require(predicate, "predicate");
        ...
        public static T SingleOrDefault<T>(this PooledLinkedList<T> source)
        {
            Contract.Require(source, "source");
        ...
        /// <param name="predicate">The predicate against which to evaluate the items of <paramref name="source"/>.</param>
        /// <returns>The single item in the source list, or a default value.</returns>
        public static T SingleOrDefault<T>(this PooledLinkedList<T> source, Predicate<T> predicate)
        {
            Contract.Require(source, "source");
            Contract.Require(predicate, "predicate");
        ...
        public static T Max<T>(this PooledLinkedList<T> source)
        {
            Contract.Require(source, "source");
        ...
        public static T Min<T>(this PooledLinkedList<T> source)
        {
            Contract.Require(source, "source");
