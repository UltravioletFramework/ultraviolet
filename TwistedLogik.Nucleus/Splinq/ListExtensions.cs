...
{
    /// <summary>
    /// Contains SpLINQ extension methods for the <see cref="List{T}"/> class.
    /// </summary>
    public static class ListExtensions
    {
        ...
        /// <returns><see langword="true"/> if the source list contains any elements; otherwise, <see langword="false"/>.</returns>
        public static Boolean Any<T>(this List<T> source, Predicate<T> predicate)
        {
            Contract.Require(source, nameof(source));
        ...
        public static Boolean All<T>(this List<T> source, Predicate<T> predicate)
        {
            Contract.Require(source, nameof(source));
            Contract.Require(predicate, nameof(predicate));
        ...
        public static Int32 Count<T>(this List<T> source)
        {
            Contract.Require(source, nameof(source));
        ...
        /// <param name="predicate">The predicate against which to evaluate the items of <paramref name="source"/>.</param>
        /// <returns>The number of items in the source list.</returns>
        public static Int32 Count<T>(this List<T> source, Predicate<T> predicate)
        {
            Contract.Require(source, nameof(source));
            Contract.Require(predicate, nameof(predicate));
