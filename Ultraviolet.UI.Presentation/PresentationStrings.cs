...
namespace Ultraviolet.Presentation
{
    ...
    public static class PresentationStrings
    {
        ...
        static PresentationStrings()
        {
            ...
            using (var stream = asm.GetManifestResourceStream("Ultraviolet.UI.Presentation.Resources.Strings.xml"))
            {
                StringDatabase.LoadFromStream(stream);
            }
            using (var stream = asm.GetManifestResourceStream("Ultraviolet.UI.Presentation.Resources.Commands.xml"))
            {
                StringDatabase.LoadFromStream(stream);
            }
        }
