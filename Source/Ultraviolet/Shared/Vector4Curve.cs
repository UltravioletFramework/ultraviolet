...
namespace Ultraviolet
{
    ...
    public static class Vector4Curve
    {
        ...
        /// for points after the end of the curve.</param>
        /// <param name="keys">A collection of <see cref="CurveKey{Single}"/> objects from which to construct the curve.</param>
        public static Curve<Vector4, SmoothCurveKey<Vector4>> Smooth(CurveLoopType preLoop, CurveLoopType postLoop, IEnumerable<SmoothCurveKey<Vector4>> keys) =>
            new Curve<Vector4, SmoothCurveKey<Vector4>>(preLoop, postLoop, Vector4CurveSmoothSampler.Instance, keys);
