...
namespace Ultraviolet
{
    ...
    public class Vector2CurveLinearSampler : ICurveSampler<Vector2, CurveKey<Vector2>>
    {
        ...
        /// <inheritdoc/>
        public Vector2 InterpolateKeyframes(CurveKey<Vector2> key1, CurveKey<Vector2> key2, Single t, Vector2 offset)
        {
        ...
        /// <inheritdoc/>
        public Vector2 CalculateLinearExtension(CurveKey<Vector2> key, Single position, CurvePositionType positionType) =>
            key.Value;
