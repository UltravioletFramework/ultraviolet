...
namespace Ultraviolet
{
    ...
    public static class Vector2Curve
    {
        ...
        /// for points after the end of the curve.</param>
        /// <param name="keys">A collection of <see cref="CurveKey{Single}"/> objects from which to construct the curve.</param>
        public static Curve<Vector2, SmoothCurveKey<Vector2>> Smooth(CurveLoopType preLoop, CurveLoopType postLoop, IEnumerable<SmoothCurveKey<Vector2>> keys) =>
            new Curve<Vector2, SmoothCurveKey<Vector2>>(preLoop, postLoop, Vector2CurveSmoothSampler.Instance, keys);
