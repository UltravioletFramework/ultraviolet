...
#pragma warning disable 1591
    ...
    internal sealed unsafe class BASSFXNativeImpl_iOS : BASSFXNativeImpl
    {
        [DllImport("__Internal", EntryPoint = "BASS_FX_TempoCreate", CallingConvention = CallingConvention.StdCall)]
