...
namespace Ultraviolet.Shims.macOS.Graphics
{
    ...
    /// </summary>
    public sealed unsafe class macOSSurfaceSource : SurfaceSource
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="macOSSurfaceSource"/> class from the specified stream.
        /// </summary>
        /// <param name="stream">The <see cref="Stream"/> that contains the surface data.</param>
        public macOSSurfaceSource(Stream stream)
        {
