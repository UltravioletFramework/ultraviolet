...
namespace Ultraviolet.SDL2.Native
{
    ...
    public unsafe static class SDL
    {
        ...
        private static IntPtr GetError_Impl() => pSDL_GetError();
#endif
        ...
        public static void SetEventFilter(IntPtr filter, IntPtr userdata) => pSDL_SetEventFilter(filter, userdata);
#endif
        ...
        public static IntPtr CreateWindow(String title, Int32 x, Int32 y, Int32 w, Int32 h, SDL_WindowFlags flags) => pSDL_CreateWindow(title, x, y, w, h, flags);
#endif
        ...
        private static extern IntPtr GetWindowTitle_Impl(IntPtr window);
#else
        [MonoNativeFunctionWrapper]
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        ...
        private static IntPtr GetWindowTitle_Impl(IntPtr window) => pSDL_GetWindowTitle(window);
#endif
        public static String GetWindowTitle(IntPtr window) => Marshal.PtrToStringAnsi(GetWindowTitle_Impl(window));
        ...
        public static void SetWindowTitle(IntPtr window, String title) => pSDL_SetWindowTitle(window, title);
#endif
        ...
        public static extern void GetWindowGrab(IntPtr window);
#else
        [MonoNativeFunctionWrapper]
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        ...
        public static Int32 GetWindowDisplayIndex(IntPtr window) => pSDL_GetWindowDisplayIndex(window);
#endif
        ...
        public static extern Boolean GetWindowWMInfo(IntPtr window, SDL_SysWMinfo* info);
#else
        [MonoNativeFunctionWrapper]
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        ...
        public static IntPtr RWFromFile(String file, String mode) => pSDL_RWFromFile(file, mode);
#endif
        ...
        public static IntPtr RWFromMem(IntPtr mem, Int32 size) => pSDL_RWFromMem(mem, size);
#endif
        ...
        public static Boolean SetHint(String name, String value) => pSDL_SetHint(name, value);
#endif
        ...
        public static extern Int32 BlitSurface(SDL_Surface* src, SDL_Rect* srcrect, SDL_Surface* dst, SDL_Rect* dstrect);
#else
        [MonoNativeFunctionWrapper]
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        ...
        public static Int32 BlitSurface(SDL_Surface* src, SDL_Rect* srcrect, SDL_Surface* dst, SDL_Rect* dstrect) => p_SDL_UpperBlit(src, srcrect, dst, dstrect);
#endif

#if ANDROID || IOS
        [DllImport(LIBRARY, EntryPoint="SDL_UpperBlitScaled", CallingConvention = CallingConvention.Cdecl)]
        public static extern Int32 BlitScaled(SDL_Surface* src, SDL_Rect* srcrect, SDL_Surface* dst, SDL_Rect* dstrect);
#else
        [MonoNativeFunctionWrapper]
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        ...
        private static IntPtr GetDisplayName_Impl(Int32 displayIndex) => pSDL_GetDisplayName(displayIndex);
#endif
        public static String GetDisplayName(Int32 displayIndex) => Marshal.PtrToStringAnsi(GetDisplayName_Impl(displayIndex));
        ...
        public static IntPtr GL_GetProcAddress(String proc) => pSDL_GL_GetProcAddress(proc);
#endif
        ...
        public static extern void GameControllerClose(IntPtr gamecontroller);
#else
        [MonoNativeFunctionWrapper]
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        ...
        public static void GameControllerClose(IntPtr gamecontroller) => pSDL_GameControllerClose(gamecontroller);
#endif
        ...
        private static IntPtr GameControllerNameForIndex_Impl(Int32 joystick_index) => pSDL_GameControllerNameForIndex(joystick_index);
#endif
        public static String GameControllerNameForIndex(Int32 joystick_index) => Marshal.PtrToStringAnsi(GameControllerNameForIndex_Impl(joystick_index));
        ...
        public static extern Int32 SaveDollarTemplate(Int64 gestureID, IntPtr dst);
#else
        [MonoNativeFunctionWrapper]
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        ...
        private static IntPtr GetClipboardText_Impl() => pSDL_GetClipboardText();
#endif
        public static String GetClipboardText() => Marshal.PtrToStringAnsi(GetClipboardText_Impl());
        ...
        public static void SetClipboardText(String text) => pSDL_SetClipboardText(text);
#endif
        ...
        public static Int32 ShowSimpleMessageBox(UInt32 flags, String title, String message, IntPtr window) => pSDL_ShowSimpleMessageBox(flags, title, message, window);
#endif
