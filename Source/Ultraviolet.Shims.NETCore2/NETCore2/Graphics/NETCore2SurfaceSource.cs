...
namespace Ultraviolet.Shims.NETCore2.Graphics
{
    ...
    /// </summary>
    [CLSCompliant(false)]
    public sealed class NETCore2SurfaceSource : SurfaceSource
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NETCore2SurfaceSource"/> class.
        /// </summary>
        /// <param name="stream">The <see cref="Stream"/> that contains the surface data.</param>
        public NETCore2SurfaceSource(Stream stream)
        {
        ...
        public NETCore2SurfaceSource(Bitmap bmp)
        {
