...
namespace Ultraviolet.Shims.NETCore2.Platform
{
    ...
    /// </summary>
    public sealed partial class NETCore2ScreenDensityService : ScreenDensityService
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NETCore2ScreenDensityService"/> class.
        /// </summary>
        /// <param name="uv">The Ultraviolet context.</param>
        /// <param name="display">The <see cref="IUltravioletDisplay"/> for which to retrieve density information.</param>
        public NETCore2ScreenDensityService(UltravioletContext uv, IUltravioletDisplay display)
            : base(display)
        {
