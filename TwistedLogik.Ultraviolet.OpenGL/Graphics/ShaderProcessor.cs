...
namespace TwistedLogik.Ultraviolet.OpenGL.Graphics
{
    ...
    public abstract class ShaderProcessor<TOutput> : ContentProcessor<String, TOutput>
    {
        ...
        protected string ProcessShaderDirectives(ContentManager manager, IContentProcessorMetadata metadata, String source)
        {
            return ShaderCompiler.ProcessShaderDirectives(source, (line, output) =>
            {
