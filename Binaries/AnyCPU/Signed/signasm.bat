...
sn.exe -R "Ultraviolet.UI.Presentation.dll" "%TLSN%"
sn.exe -R "Ultraviolet.UI.Presentation.Uvss.dll" "%TLSN%"
sn.exe -R "Ultraviolet.UI.Presentation.Compiler.dll" "%TLSN%"
sn.exe -R "Ultraviolet.UI.Presentation.RoslynCompiler.dll" "%TLSN%"
