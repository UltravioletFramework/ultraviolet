...
namespace TwistedLogik.Gluon
{
    public static unsafe partial class gl
    {
        ...
        private delegate void glUniformMatrix2x3fvDelegate(int location, int count, bool transpose, IntPtr value);
        ...
        [MonoNativeFunctionWrapper]
        private delegate void glUniformMatrix3x2fvDelegate(int location, int count, bool transpose, IntPtr value);
        [Require(MinVersion = "2.1")]
        ...
        [MonoNativeFunctionWrapper]
        private delegate void glUniformMatrix2x4fvDelegate(int location, int count, bool transpose, IntPtr value);
        [Require(MinVersion = "2.1")]
        ...
        [MonoNativeFunctionWrapper]
        private delegate void glUniformMatrix4x2fvDelegate(int location, int count, bool transpose, IntPtr value);
        [Require(MinVersion = "2.1")]
        ...
        [MonoNativeFunctionWrapper]
        private delegate void glUniformMatrix3x4fvDelegate(int location, int count, bool transpose, IntPtr value);
        [Require(MinVersion = "2.1")]
        ...
        [MonoNativeFunctionWrapper]
        private delegate void glUniformMatrix4x3fvDelegate(int location, int count, bool transpose, IntPtr value);
        [Require(MinVersion = "2.1")]
