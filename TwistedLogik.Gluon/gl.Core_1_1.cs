...
namespace TwistedLogik.Gluon
{
    public static unsafe partial class gl
    {
        ...
        private static readonly glAccumDelegate glAccum = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glAlphaFuncDelegate glAlphaFunc = null;

        public static void AlphaFunc(uint func, float @ref) { glAlphaFunc(func, @ref); }

        private delegate bool glAreTexturesResidentDelegate(int n, uint* textures, bool* residences);
        [Require(MinVersion = "1.1")]
        private static readonly glAreTexturesResidentDelegate glAreTexturesResident = null;

        public static bool AreTexturesResident(int n, uint* textures, bool* residences) { return glAreTexturesResident(n, textures, residences); }

        private delegate void glArrayElementDelegate(int i);
        [Require(MinVersion = "1.1")]
        private static readonly glArrayElementDelegate glArrayElement = null;

        public static void ArrayElement(int i) { glArrayElement(i); }

        private delegate void glBeginDelegate(uint mode);
        [Require(MinVersion = "1.1")]
        private static readonly glBeginDelegate glBegin = null;

        public static void Begin(uint mode) { glBegin(mode); }

        private delegate void glBindTextureDelegate(uint target, uint texture);
        [Require(MinVersion = "1.1")]
        private static readonly glBindTextureDelegate glBindTexture = null;
        ...
        public static void Bitmap(int width, int height, float xorig, float yorig, float xmove, float ymove, byte* bitmap) { glBitmap(width, height, xorig, yorig, xmove, ymove, bitmap); }

        private delegate void glBlendFuncDelegate(uint sfactor, uint dfactor);
        [Require(MinVersion = "1.1")]
        private static readonly glBlendFuncDelegate glBlendFunc = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glCallListDelegate glCallList = null;

        public static void CallList(uint list) { glCallList(list); }

        private delegate void glCallListsDelegate(int n, uint type, void* lists);
        [Require(MinVersion = "1.1")]
        private static readonly glCallListsDelegate glCallLists = null;

        public static void CallLists(int n, uint type, void* lists) { glCallLists(n, type, lists); }

        private delegate void glClearDelegate(uint mask);
        [Require(MinVersion = "1.1")]
        private static readonly glClearDelegate glClear = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glClearAccumDelegate glClearAccum = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glClearColorDelegate glClearColor = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glClearIndexDelegate glClearIndex = null;

        public static void ClearIndex(float c) { glClearIndex(c); }

        private delegate void glClearStencilDelegate(int s);
        [Require(MinVersion = "1.1")]
        private static readonly glClearStencilDelegate glClearStencil = null;

        public static void ClearStencil(int s) { glClearStencil(s); }

        private delegate void glClipPlaneDelegate(uint plane, double* equation);
        [Require(MinVersion = "1.1")]
        private static readonly glClipPlaneDelegate glClipPlane = null;

        public static void ClipPlane(uint plane, double* equation) { glClipPlane(plane, equation); }

        private delegate void glColor3bDelegate(sbyte red, sbyte green, sbyte blue);
        [Require(MinVersion = "1.1")]
        private static readonly glColor3bDelegate glColor3b = null;

        public static void Color3b(sbyte red, sbyte green, sbyte blue) { glColor3b(red, green, blue); }

        private delegate void glColor3bvDelegate(sbyte* v);
        [Require(MinVersion = "1.1")]
        private static readonly glColor3bvDelegate glColor3bv = null;

        public static void Color3bv(sbyte* v) { glColor3bv(v); }

        private delegate void glColor3dDelegate(double red, double green, double blue);
        [Require(MinVersion = "1.1")]
        private static readonly glColor3dDelegate glColor3d = null;

        public static void Color3d(double red, double green, double blue) { glColor3d(red, green, blue); }

        private delegate void glColor3dvDelegate(double* v);
        [Require(MinVersion = "1.1")]
        private static readonly glColor3dvDelegate glColor3dv = null;

        public static void Color3dv(double* v) { glColor3dv(v); }

        private delegate void glColor3fDelegate(float red, float green, float blue);
        [Require(MinVersion = "1.1")]
        private static readonly glColor3fDelegate glColor3f = null;

        public static void Color3f(float red, float green, float blue) { glColor3f(red, green, blue); }

        private delegate void glColor3fvDelegate(float* v);
        [Require(MinVersion = "1.1")]
        private static readonly glColor3fvDelegate glColor3fv = null;

        public static void Color3fv(float* v) { glColor3fv(v); }

        private delegate void glColor3iDelegate(int red, int green, int blue);
        [Require(MinVersion = "1.1")]
        private static readonly glColor3iDelegate glColor3i = null;

        public static void Color3i(int red, int green, int blue) { glColor3i(red, green, blue); }

        private delegate void glColor3ivDelegate(int* v);
        [Require(MinVersion = "1.1")]
        private static readonly glColor3ivDelegate glColor3iv = null;

        public static void Color3iv(int* v) { glColor3iv(v); }

        private delegate void glColor3sDelegate(short red, short green, short blue);
        [Require(MinVersion = "1.1")]
        private static readonly glColor3sDelegate glColor3s = null;

        public static void Color3s(short red, short green, short blue) { glColor3s(red, green, blue); }

        private delegate void glColor3svDelegate(short* v);
        [Require(MinVersion = "1.1")]
        private static readonly glColor3svDelegate glColor3sv = null;

        public static void Color3sv(short* v) { glColor3sv(v); }

        private delegate void glColor3ubDelegate(byte red, byte green, byte blue);
        [Require(MinVersion = "1.1")]
        private static readonly glColor3ubDelegate glColor3ub = null;

        public static void Color3ub(byte red, byte green, byte blue) { glColor3ub(red, green, blue); }

        private delegate void glColor3ubvDelegate(byte* v);
        [Require(MinVersion = "1.1")]
        private static readonly glColor3ubvDelegate glColor3ubv = null;

        public static void Color3ubv(byte* v) { glColor3ubv(v); }

        private delegate void glColor3uiDelegate(uint red, uint green, uint blue);
        [Require(MinVersion = "1.1")]
        private static readonly glColor3uiDelegate glColor3ui = null;

        public static void Color3ui(uint red, uint green, uint blue) { glColor3ui(red, green, blue); }

        private delegate void glColor3uivDelegate(uint* v);
        [Require(MinVersion = "1.1")]
        private static readonly glColor3uivDelegate glColor3uiv = null;

        public static void Color3uiv(uint* v) { glColor3uiv(v); }

        private delegate void glColor3usDelegate(ushort red, ushort green, ushort blue);
        [Require(MinVersion = "1.1")]
        private static readonly glColor3usDelegate glColor3us = null;

        public static void Color3us(ushort red, ushort green, ushort blue) { glColor3us(red, green, blue); }

        private delegate void glColor3usvDelegate(ushort* v);
        [Require(MinVersion = "1.1")]
        private static readonly glColor3usvDelegate glColor3usv = null;

        public static void Color3usv(ushort* v) { glColor3usv(v); }

        private delegate void glColor4bDelegate(sbyte red, sbyte green, sbyte blue, sbyte alpha);
        [Require(MinVersion = "1.1")]
        private static readonly glColor4bDelegate glColor4b = null;

        public static void Color4b(sbyte red, sbyte green, sbyte blue, sbyte alpha) { glColor4b(red, green, blue, alpha); }

        private delegate void glColor4bvDelegate(sbyte* v);
        [Require(MinVersion = "1.1")]
        private static readonly glColor4bvDelegate glColor4bv = null;

        public static void Color4bv(sbyte* v) { glColor4bv(v); }

        private delegate void glColor4dDelegate(double red, double green, double blue, double alpha);
        [Require(MinVersion = "1.1")]
        private static readonly glColor4dDelegate glColor4d = null;

        public static void Color4d(double red, double green, double blue, double alpha) { glColor4d(red, green, blue, alpha); }

        private delegate void glColor4dvDelegate(double* v);
        [Require(MinVersion = "1.1")]
        private static readonly glColor4dvDelegate glColor4dv = null;

        public static void Color4dv(double* v) { glColor4dv(v); }

        private delegate void glColor4fDelegate(float red, float green, float blue, float alpha);
        [Require(MinVersion = "1.1")]
        private static readonly glColor4fDelegate glColor4f = null;

        public static void Color4f(float red, float green, float blue, float alpha) { glColor4f(red, green, blue, alpha); }

        private delegate void glColor4fvDelegate(float* v);
        [Require(MinVersion = "1.1")]
        private static readonly glColor4fvDelegate glColor4fv = null;

        public static void Color4fv(float* v) { glColor4fv(v); }

        private delegate void glColor4iDelegate(int red, int green, int blue, int alpha);
        [Require(MinVersion = "1.1")]
        private static readonly glColor4iDelegate glColor4i = null;

        public static void Color4i(int red, int green, int blue, int alpha) { glColor4i(red, green, blue, alpha); }

        private delegate void glColor4ivDelegate(int* v);
        [Require(MinVersion = "1.1")]
        private static readonly glColor4ivDelegate glColor4iv = null;

        public static void Color4iv(int* v) { glColor4iv(v); }

        private delegate void glColor4sDelegate(short red, short green, short blue, short alpha);
        [Require(MinVersion = "1.1")]
        private static readonly glColor4sDelegate glColor4s = null;

        public static void Color4s(short red, short green, short blue, short alpha) { glColor4s(red, green, blue, alpha); }

        private delegate void glColor4svDelegate(short* v);
        [Require(MinVersion = "1.1")]
        private static readonly glColor4svDelegate glColor4sv = null;

        public static void Color4sv(short* v) { glColor4sv(v); }

        private delegate void glColor4ubDelegate(byte red, byte green, byte blue, byte alpha);
        [Require(MinVersion = "1.1")]
        private static readonly glColor4ubDelegate glColor4ub = null;

        public static void Color4ub(byte red, byte green, byte blue, byte alpha) { glColor4ub(red, green, blue, alpha); }

        private delegate void glColor4ubvDelegate(byte* v);
        [Require(MinVersion = "1.1")]
        private static readonly glColor4ubvDelegate glColor4ubv = null;

        public static void Color4ubv(byte* v) { glColor4ubv(v); }

        private delegate void glColor4uiDelegate(uint red, uint green, uint blue, uint alpha);
        [Require(MinVersion = "1.1")]
        private static readonly glColor4uiDelegate glColor4ui = null;

        public static void Color4ui(uint red, uint green, uint blue, uint alpha) { glColor4ui(red, green, blue, alpha); }

        private delegate void glColor4uivDelegate(uint* v);
        [Require(MinVersion = "1.1")]
        private static readonly glColor4uivDelegate glColor4uiv = null;

        public static void Color4uiv(uint* v) { glColor4uiv(v); }

        private delegate void glColor4usDelegate(ushort red, ushort green, ushort blue, ushort alpha);
        [Require(MinVersion = "1.1")]
        private static readonly glColor4usDelegate glColor4us = null;

        public static void Color4us(ushort red, ushort green, ushort blue, ushort alpha) { glColor4us(red, green, blue, alpha); }

        private delegate void glColor4usvDelegate(ushort* v);
        [Require(MinVersion = "1.1")]
        private static readonly glColor4usvDelegate glColor4usv = null;

        public static void Color4usv(ushort* v) { glColor4usv(v); }
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glColorMaterialDelegate glColorMaterial = null;

        public static void ColorMaterial(uint face, uint mode) { glColorMaterial(face, mode); }

        private delegate void glColorPointerDelegate(int size, uint type, int stride, void* pointer);
        [Require(MinVersion = "1.1")]
        private static readonly glColorPointerDelegate glColorPointer = null;

        public static void ColorPointer(int size, uint type, int stride, void* pointer) { glColorPointer(size, type, stride, pointer); }

        private delegate void glCopyPixelsDelegate(int x, int y, int width, int height, uint type);
        [Require(MinVersion = "1.1")]
        private static readonly glCopyPixelsDelegate glCopyPixels = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glCopyTexImage1DDelegate glCopyTexImage1D = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glCopyTexImage2DDelegate glCopyTexImage2D = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glCopyTexSubImage1DDelegate glCopyTexSubImage1D = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glCopyTexSubImage2DDelegate glCopyTexSubImage2D = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glCullFaceDelegate glCullFace = null;

        public static void CullFace(uint mode) { glCullFace(mode); }

        private delegate void glDeleteListsDelegate(uint list, int range);
        [Require(MinVersion = "1.1")]
        private static readonly glDeleteListsDelegate glDeleteLists = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glDeleteTexturesDelegate glDeleteTextures = null;

        public static void DeleteTextures(int n, uint* textures) { glDeleteTextures(n, textures); }

        public static void DeleteTextures(uint[] textures)
        {
            fixed (uint* ptextures = textures)
            {
                glDeleteTextures(textures.Length, ptextures);
            }
        }
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glDepthFuncDelegate glDepthFunc = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glDepthRangeDelegate glDepthRange = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glDisableDelegate glDisable = null;

        public static void Disable(uint cap) { glDisable(cap); }

        private delegate void glDisableClientStateDelegate(uint array);
        [Require(MinVersion = "1.1")]
        private static readonly glDisableClientStateDelegate glDisableClientState = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glDrawArraysDelegate glDrawArrays = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glDrawBufferDelegate glDrawBuffer = null;

        public static void DrawBuffer(uint mode) { glDrawBuffer(mode); }

        private delegate void glDrawElementsDelegate(uint mode, int count, uint type, void* indices);
        [Require(MinVersion = "1.1")]
        private static readonly glDrawElementsDelegate glDrawElements = null;

        public static void DrawElements(uint mode, int count, uint type, void* indices) { glDrawElements(mode, count, type, indices); }

        private delegate void glDrawPixelsDelegate(int width, int height, uint format, uint type, void* pixels);
        [Require(MinVersion = "1.1")]
        private static readonly glDrawPixelsDelegate glDrawPixels = null;

        public static void DrawPixels(int width, int height, uint format, uint type, void* pixels) { glDrawPixels(width, height, format, type, pixels); }
        ...
        private delegate void glEdgeFlagPointerDelegate(int stride, void* pointer);
        [Require(MinVersion = "1.1")]
        private static readonly glEdgeFlagPointerDelegate glEdgeFlagPointer = null;

        public static void EdgeFlagPointer(int stride, void* pointer) { glEdgeFlagPointer(stride, pointer); }

        private delegate void glEdgeFlagvDelegate(bool* flag);
        [Require(MinVersion = "1.1")]
        private static readonly glEdgeFlagvDelegate glEdgeFlagv = null;

        public static void EdgeFlagv(bool* flag) { glEdgeFlagv(flag); }

        private delegate void glEnableDelegate(uint cap);
        [Require(MinVersion = "1.1")]
        private static readonly glEnableDelegate glEnable = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glEnableClientStateDelegate glEnableClientState = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glEvalCoord1dDelegate glEvalCoord1d = null;

        public static void EvalCoord1d(double u) { glEvalCoord1d(u); }

        private delegate void glEvalCoord1dvDelegate(double* u);
        [Require(MinVersion = "1.1")]
        private static readonly glEvalCoord1dvDelegate glEvalCoord1dv = null;

        public static void EvalCoord1dv(double* u) { glEvalCoord1dv(u); }

        private delegate void glEvalCoord1fDelegate(float u);
        [Require(MinVersion = "1.1")]
        private static readonly glEvalCoord1fDelegate glEvalCoord1f = null;

        public static void EvalCoord1f(float u) { glEvalCoord1f(u); }

        private delegate void glEvalCoord1fvDelegate(float* u);
        [Require(MinVersion = "1.1")]
        private static readonly glEvalCoord1fvDelegate glEvalCoord1fv = null;

        public static void EvalCoord1fv(float* u) { glEvalCoord1fv(u); }

        private delegate void glEvalCoord2dDelegate(double u, double v);
        [Require(MinVersion = "1.1")]
        private static readonly glEvalCoord2dDelegate glEvalCoord2d = null;

        public static void EvalCoord2d(double u, double v) { glEvalCoord2d(u, v); }

        private delegate void glEvalCoord2dvDelegate(double* u);
        [Require(MinVersion = "1.1")]
        private static readonly glEvalCoord2dvDelegate glEvalCoord2dv = null;

        public static void EvalCoord2dv(double* u) { glEvalCoord2dv(u); }

        private delegate void glEvalCoord2fDelegate(float u, float v);
        [Require(MinVersion = "1.1")]
        private static readonly glEvalCoord2fDelegate glEvalCoord2f = null;

        public static void EvalCoord2f(float u, float v) { glEvalCoord2f(u, v); }

        private delegate void glEvalCoord2fvDelegate(float* u);
        [Require(MinVersion = "1.1")]
        private static readonly glEvalCoord2fvDelegate glEvalCoord2fv = null;

        public static void EvalCoord2fv(float* u) { glEvalCoord2fv(u); }

        private delegate void glEvalMesh1Delegate(uint mode, int i1, int i2);
        [Require(MinVersion = "1.1")]
        private static readonly glEvalMesh1Delegate glEvalMesh1 = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glEvalMesh2Delegate glEvalMesh2 = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glEvalPoint1Delegate glEvalPoint1 = null;

        public static void EvalPoint1(int i) { glEvalPoint1(i); }

        private delegate void glEvalPoint2Delegate(int i, int j);
        [Require(MinVersion = "1.1")]
        private static readonly glEvalPoint2Delegate glEvalPoint2 = null;

        public static void EvalPoint2(int i, int j) { glEvalPoint2(i, j); }

        private delegate void glFeedbackBufferDelegate(int size, uint type, float* buffer);
        [Require(MinVersion = "1.1")]
        private static readonly glFeedbackBufferDelegate glFeedbackBuffer = null;

        public static void FeedbackBuffer(int size, uint type, float* buffer) { glFeedbackBuffer(size, type, buffer); }
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glFogfDelegate glFogf = null;

        public static void Fogf(uint pname, float param) { glFogf(pname, param); }

        private delegate void glFogfvDelegate(uint pname, float* @params);
        [Require(MinVersion = "1.1")]
        private static readonly glFogfvDelegate glFogfv = null;

        public static void Fogfv(uint pname, float* @params) { glFogfv(pname, @params); }

        private delegate void glFogiDelegate(uint pname, int param);
        [Require(MinVersion = "1.1")]
        private static readonly glFogiDelegate glFogi = null;

        public static void Fogi(uint pname, int param) { glFogi(pname, param); }

        private delegate void glFogivDelegate(uint pname, int* @params);
        [Require(MinVersion = "1.1")]
        private static readonly glFogivDelegate glFogiv = null;

        public static void Fogiv(uint pname, int* @params) { glFogiv(pname, @params); }

        private delegate void glFrontFaceDelegate(uint mode);
        [Require(MinVersion = "1.1")]
        private static readonly glFrontFaceDelegate glFrontFace = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glFrustumDelegate glFrustum = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glGenListsDelegate glGenLists = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glGenTexturesDelegate glGenTextures = null;

        public static void GenTextures(int n, uint* textures) { glGenTextures(n, textures); }

        public static void GenTextures(uint[] textures)
        {
            fixed (uint* ptextures = textures)
            {
                glGenTextures(textures.Length, ptextures);
            }
        }
        ...
        private delegate void glGetBooleanvDelegate(uint pname, bool* @params);
        [Require(MinVersion = "1.1")]
        private static readonly glGetBooleanvDelegate glGetBooleanv = null;

        public static void GetBooleanv(uint pname, bool* @params) { glGetBooleanv(pname, @params); }
        ...
        private delegate void glGetClipPlaneDelegate(uint plane, double* equation);
        [Require(MinVersion = "1.1")]
        private static readonly glGetClipPlaneDelegate glGetClipPlane = null;

        public static void GetClipPlane(uint plane, double* equation) { glGetClipPlane(plane, equation); }

        private delegate void glGetDoublevDelegate(uint pname, double* @params);
        [Require(MinVersion = "1.1")]
        private static readonly glGetDoublevDelegate glGetDoublev = null;

        public static void GetDoublev(uint pname, double* @params) { glGetDoublev(pname, @params); }
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glGetErrorDelegate glGetError = null;

        public static uint GetError() { return glGetError(); }

        private delegate void glGetFloatvDelegate(uint pname, float* @params);
        [Require(MinVersion = "1.1")]
        private static readonly glGetFloatvDelegate glGetFloatv = null;

        public static void GetFloatv(uint pname, float* @params) { glGetFloatv(pname, @params); }
        ...
        private delegate void glGetIntegervDelegate(uint pname, int* @params);
        [Require(MinVersion = "1.1")]
        private static readonly glGetIntegervDelegate glGetIntegerv = null;

        public static void GetIntegerv(uint pname, int* @params) { glGetIntegerv(pname, @params); }
        ...
        private delegate void glGetLightfvDelegate(uint light, uint pname, float* @params);
        [Require(MinVersion = "1.1")]
        private static readonly glGetLightfvDelegate glGetLightfv = null;

        public static void GetLightfv(uint light, uint pname, float* @params) { glGetLightfv(light, pname, @params); }

        private delegate void glGetLightivDelegate(uint light, uint pname, int* @params);
        [Require(MinVersion = "1.1")]
        private static readonly glGetLightivDelegate glGetLightiv = null;

        public static void GetLightiv(uint light, uint pname, int* @params) { glGetLightiv(light, pname, @params); }

        private delegate void glGetMapdvDelegate(uint target, uint query, double* v);
        [Require(MinVersion = "1.1")]
        private static readonly glGetMapdvDelegate glGetMapdv = null;

        public static void GetMapdv(uint target, uint query, double* v) { glGetMapdv(target, query, v); }

        private delegate void glGetMapfvDelegate(uint target, uint query, float* v);
        [Require(MinVersion = "1.1")]
        private static readonly glGetMapfvDelegate glGetMapfv = null;

        public static void GetMapfv(uint target, uint query, float* v) { glGetMapfv(target, query, v); }

        private delegate void glGetMapivDelegate(uint target, uint query, int* v);
        [Require(MinVersion = "1.1")]
        private static readonly glGetMapivDelegate glGetMapiv = null;

        public static void GetMapiv(uint target, uint query, int* v) { glGetMapiv(target, query, v); }

        private delegate void glGetMaterialfvDelegate(uint face, uint pname, float* @params);
        [Require(MinVersion = "1.1")]
        private static readonly glGetMaterialfvDelegate glGetMaterialfv = null;

        public static void GetMaterialfv(uint face, uint pname, float* @params) { glGetMaterialfv(face, pname, @params); }

        private delegate void glGetMaterialivDelegate(uint face, uint pname, int* @params);
        [Require(MinVersion = "1.1")]
        private static readonly glGetMaterialivDelegate glGetMaterialiv = null;

        public static void GetMaterialiv(uint face, uint pname, int* @params) { glGetMaterialiv(face, pname, @params); }

        private delegate void glGetPixelMapfvDelegate(uint map, float* values);
        [Require(MinVersion = "1.1")]
        private static readonly glGetPixelMapfvDelegate glGetPixelMapfv = null;

        public static void GetPixelMapfv(uint map, float* values) { glGetPixelMapfv(map, values); }

        private delegate void glGetPixelMapuivDelegate(uint map, uint* values);
        [Require(MinVersion = "1.1")]
        private static readonly glGetPixelMapuivDelegate glGetPixelMapuiv = null;

        public static void GetPixelMapuiv(uint map, uint* values) { glGetPixelMapuiv(map, values); }

        private delegate void glGetPixelMapusvDelegate(uint map, ushort* values);
        [Require(MinVersion = "1.1")]
        private static readonly glGetPixelMapusvDelegate glGetPixelMapusv = null;

        public static void GetPixelMapusv(uint map, ushort* values) { glGetPixelMapusv(map, values); }

        private delegate void glGetPointervDelegate(uint pname, void** @params);
        [Require(MinVersion = "1.1")]
        private static readonly glGetPointervDelegate glGetPointerv = null;

        public static void GetPointerv(uint pname, void** @params) { glGetPointerv(pname, @params); }

        private delegate void glGetPolygonStippleDelegate(byte* mask);
        [Require(MinVersion = "1.1")]
        private static readonly glGetPolygonStippleDelegate glGetPolygonStipple = null;

        public static void GetPolygonStipple(byte* mask) { glGetPolygonStipple(mask); }

        private delegate byte* glGetStringDelegate(uint name);
        [Require(MinVersion = "1.1")]
        private static readonly glGetStringDelegate glGetString = null;
        ...
        private delegate void glGetTexEnvfvDelegate(uint target, uint pname, float* @params);
        [Require(MinVersion = "1.1")]
        private static readonly glGetTexEnvfvDelegate glGetTexEnvfv = null;

        public static void GetTexEnvfv(uint target, uint pname, float* @params) { glGetTexEnvfv(target, pname, @params); }

        private delegate void glGetTexEnvivDelegate(uint target, uint pname, int* @params);
        [Require(MinVersion = "1.1")]
        private static readonly glGetTexEnvivDelegate glGetTexEnviv = null;

        public static void GetTexEnviv(uint target, uint pname, int* @params) { glGetTexEnviv(target, pname, @params); }

        private delegate void glGetTexGendvDelegate(uint coord, uint pname, double* @params);
        [Require(MinVersion = "1.1")]
        private static readonly glGetTexGendvDelegate glGetTexGendv = null;

        public static void GetTexGendv(uint coord, uint pname, double* @params) { glGetTexGendv(coord, pname, @params); }

        private delegate void glGetTexGenfvDelegate(uint coord, uint pname, float* @params);
        [Require(MinVersion = "1.1")]
        private static readonly glGetTexGenfvDelegate glGetTexGenfv = null;

        public static void GetTexGenfv(uint coord, uint pname, float* @params) { glGetTexGenfv(coord, pname, @params); }

        private delegate void glGetTexGenivDelegate(uint coord, uint pname, int* @params);
        [Require(MinVersion = "1.1")]
        private static readonly glGetTexGenivDelegate glGetTexGeniv = null;

        public static void GetTexGeniv(uint coord, uint pname, int* @params) { glGetTexGeniv(coord, pname, @params); }

        private delegate void glGetTexImageDelegate(uint target, int level, uint format, uint type, void* pixels);
        [Require(MinVersion = "1.1")]
        private static readonly glGetTexImageDelegate glGetTexImage = null;

        public static void GetTexImage(uint target, int level, uint format, uint type, void* pixels) { glGetTexImage(target, level, format, type, pixels); }

        private delegate void glGetTexLevelParameterfvDelegate(uint target, int level, uint pname, float* @params);
        [Require(MinVersion = "1.1")]
        private static readonly glGetTexLevelParameterfvDelegate glGetTexLevelParameterfv = null;

        public static void GetTexLevelParameterfv(uint target, int level, uint pname, float* @params) { glGetTexLevelParameterfv(target, level, pname, @params); }

        private delegate void glGetTexLevelParameterivDelegate(uint target, int level, uint pname, int* @params);
        [Require(MinVersion = "1.1")]
        private static readonly glGetTexLevelParameterivDelegate glGetTexLevelParameteriv = null;

        public static void GetTexLevelParameteriv(uint target, int level, uint pname, int* @params) { glGetTexLevelParameteriv(target, level, pname, @params); }

        private delegate void glGetTexParameterfvDelegate(uint target, uint pname, float* @params);
        [Require(MinVersion = "1.1")]
        private static readonly glGetTexParameterfvDelegate glGetTexParameterfv = null;

        public static void GetTexParameterfv(uint target, uint pname, float* @params) { glGetTexParameterfv(target, pname, @params); }

        private delegate void glGetTexParameterivDelegate(uint target, uint pname, int* @params);
        [Require(MinVersion = "1.1")]
        private static readonly glGetTexParameterivDelegate glGetTexParameteriv = null;

        public static void GetTexParameteriv(uint target, uint pname, int* @params) { glGetTexParameteriv(target, pname, @params); }

        private delegate void glHintDelegate(uint target, uint mode);
        [Require(MinVersion = "1.1")]
        private static readonly glHintDelegate glHint = null;

        public static void Hint(uint target, uint mode) { glHint(target, mode); }

        private delegate void glIndexMaskDelegate(uint mask);
        [Require(MinVersion = "1.1")]
        private static readonly glIndexMaskDelegate glIndexMask = null;

        public static void IndexMask(uint mask) { glIndexMask(mask); }

        private delegate void glIndexPointerDelegate(uint type, int stride, void* pointer);
        [Require(MinVersion = "1.1")]
        private static readonly glIndexPointerDelegate glIndexPointer = null;

        public static void IndexPointer(uint type, int stride, void* pointer) { glIndexPointer(type, stride, pointer); }

        private delegate void glIndexdDelegate(double c);
        [Require(MinVersion = "1.1")]
        private static readonly glIndexdDelegate glIndexd = null;

        public static void Indexd(double c) { glIndexd(c); }

        private delegate void glIndexdvDelegate(double* c);
        [Require(MinVersion = "1.1")]
        private static readonly glIndexdvDelegate glIndexdv = null;

        public static void Indexdv(double* c) { glIndexdv(c); }

        private delegate void glIndexfDelegate(float c);
        [Require(MinVersion = "1.1")]
        private static readonly glIndexfDelegate glIndexf = null;

        public static void Indexf(float c) { glIndexf(c); }

        private delegate void glIndexfvDelegate(float* c);
        [Require(MinVersion = "1.1")]
        private static readonly glIndexfvDelegate glIndexfv = null;

        public static void Indexfv(float* c) { glIndexfv(c); }

        private delegate void glIndexiDelegate(int c);
        [Require(MinVersion = "1.1")]
        private static readonly glIndexiDelegate glIndexi = null;

        public static void Indexi(int c) { glIndexi(c); }

        private delegate void glIndexivDelegate(int* c);
        [Require(MinVersion = "1.1")]
        private static readonly glIndexivDelegate glIndexiv = null;

        public static void Indexiv(int* c) { glIndexiv(c); }

        private delegate void glIndexsDelegate(short c);
        [Require(MinVersion = "1.1")]
        private static readonly glIndexsDelegate glIndexs = null;

        public static void Indexs(short c) { glIndexs(c); }

        private delegate void glIndexsvDelegate(short* c);
        [Require(MinVersion = "1.1")]
        private static readonly glIndexsvDelegate glIndexsv = null;

        public static void Indexsv(short* c) { glIndexsv(c); }

        private delegate void glIndexubDelegate(byte c);
        [Require(MinVersion = "1.1")]
        private static readonly glIndexubDelegate glIndexub = null;

        public static void Indexub(byte c) { glIndexub(c); }

        private delegate void glIndexubvDelegate(byte* c);
        [Require(MinVersion = "1.1")]
        private static readonly glIndexubvDelegate glIndexubv = null;

        public static void Indexubv(byte* c) { glIndexubv(c); }

        private delegate void glInitNamesDelegate();
        [Require(MinVersion = "1.1")]
        private static readonly glInitNamesDelegate glInitNames = null;

        public static void InitNames() { glInitNames(); }

        private delegate void glInterleavedArraysDelegate(uint format, int stride, void* pointer);
        [Require(MinVersion = "1.1")]
        private static readonly glInterleavedArraysDelegate glInterleavedArrays = null;

        public static void InterleavedArrays(uint format, int stride, void* pointer) { glInterleavedArrays(format, stride, pointer); }
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glLightModelfDelegate glLightModelf = null;

        public static void LightModelf(uint pname, float param) { glLightModelf(pname, param); }

        private delegate void glLightModelfvDelegate(uint pname, float* @params);
        [Require(MinVersion = "1.1")]
        private static readonly glLightModelfvDelegate glLightModelfv = null;

        public static void LightModelfv(uint pname, float* @params) { glLightModelfv(pname, @params); }

        private delegate void glLightModeliDelegate(uint pname, int param);
        [Require(MinVersion = "1.1")]
        private static readonly glLightModeliDelegate glLightModeli = null;

        public static void LightModeli(uint pname, int param) { glLightModeli(pname, param); }

        private delegate void glLightModelivDelegate(uint pname, int* @params);
        [Require(MinVersion = "1.1")]
        private static readonly glLightModelivDelegate glLightModeliv = null;

        public static void LightModeliv(uint pname, int* @params) { glLightModeliv(pname, @params); }

        private delegate void glLightfDelegate(uint light, uint pname, float param);
        [Require(MinVersion = "1.1")]
        private static readonly glLightfDelegate glLightf = null;

        public static void Lightf(uint light, uint pname, float param) { glLightf(light, pname, param); }

        private delegate void glLightfvDelegate(uint light, uint pname, float* @params);
        [Require(MinVersion = "1.1")]
        private static readonly glLightfvDelegate glLightfv = null;

        public static void Lightfv(uint light, uint pname, float* @params) { glLightfv(light, pname, @params); }

        private delegate void glLightiDelegate(uint light, uint pname, int param);
        [Require(MinVersion = "1.1")]
        private static readonly glLightiDelegate glLighti = null;

        public static void Lighti(uint light, uint pname, int param) { glLighti(light, pname, param); }

        private delegate void glLightivDelegate(uint light, uint pname, int* @params);
        [Require(MinVersion = "1.1")]
        private static readonly glLightivDelegate glLightiv = null;

        public static void Lightiv(uint light, uint pname, int* @params) { glLightiv(light, pname, @params); }

        private delegate void glLineStippleDelegate(int factor, ushort pattern);
        [Require(MinVersion = "1.1")]
        private static readonly glLineStippleDelegate glLineStipple = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glLineWidthDelegate glLineWidth = null;

        public static void LineWidth(float width) { glLineWidth(width); }

        private delegate void glListBaseDelegate(uint @base);
        [Require(MinVersion = "1.1")]
        private static readonly glListBaseDelegate glListBase = null;

        public static void ListBase(uint @base) { glListBase(@base); }

        private delegate void glLoadIdentityDelegate();
        private delegate void glLoadMatrixdDelegate(double* m);
        [Require(MinVersion = "1.1")]
        private static readonly glLoadMatrixdDelegate glLoadMatrixd = null;

        public static void LoadMatrixd(double* m) { glLoadMatrixd(m); }

        private delegate void glLoadMatrixfDelegate(float* m);
        [Require(MinVersion = "1.1")]
        private static readonly glLoadMatrixfDelegate glLoadMatrixf = null;

        public static void LoadMatrixf(float* m) { glLoadMatrixf(m); }

        private delegate void glLoadNameDelegate(uint name);
        [Require(MinVersion = "1.1")]
        private static readonly glLoadNameDelegate glLoadName = null;

        public static void LoadName(uint name) { glLoadName(name); }

        private delegate void glLogicOpDelegate(uint opcode);
        [Require(MinVersion = "1.1")]
        private static readonly glLogicOpDelegate glLogicOp = null;

        public static void LogicOp(uint opcode) { glLogicOp(opcode); }

        private delegate void glMap1dDelegate(uint target, double u1, double u2, int stride, int order, double* points);
        [Require(MinVersion = "1.1")]
        private static readonly glMap1dDelegate glMap1d = null;

        public static void Map1d(uint target, double u1, double u2, int stride, int order, double* points) { glMap1d(target, u1, u2, stride, order, points); }

        private delegate void glMap1fDelegate(uint target, float u1, float u2, int stride, int order, float* points);
        [Require(MinVersion = "1.1")]
        private static readonly glMap1fDelegate glMap1f = null;

        public static void Map1f(uint target, float u1, float u2, int stride, int order, float* points) { glMap1f(target, u1, u2, stride, order, points); }

        private delegate void glMap2dDelegate(uint target, double u1, double u2, int ustride, int uorder, double v1, double v2, int vstride, int vorder, double* points);
        [Require(MinVersion = "1.1")]
        private static readonly glMap2dDelegate glMap2d = null;

        public static void Map2d(uint target, double u1, double u2, int ustride, int uorder, double v1, double v2, int vstride, int vorder, double* points) { glMap2d(target, u1, u2, ustride, uorder, v1, v2, vstride, vorder, points); }

        private delegate void glMap2fDelegate(uint target, float u1, float u2, int ustride, int uorder, float v1, float v2, int vstride, int vorder, float* points);
        [Require(MinVersion = "1.1")]
        private static readonly glMap2fDelegate glMap2f = null;

        public static void Map2f(uint target, float u1, float u2, int ustride, int uorder, float v1, float v2, int vstride, int vorder, float* points) { glMap2f(target, u1, u2, ustride, uorder, v1, v2, vstride, vorder, points); }

        private delegate void glMapGrid1dDelegate(int un, double u1, double u2);
        [Require(MinVersion = "1.1")]
        private static readonly glMapGrid1dDelegate glMapGrid1d = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glMapGrid1fDelegate glMapGrid1f = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glMapGrid2dDelegate glMapGrid2d = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glMapGrid2fDelegate glMapGrid2f = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glMaterialfDelegate glMaterialf = null;

        public static void Materialf(uint face, uint pname, float param) { glMaterialf(face, pname, param); }

        private delegate void glMaterialfvDelegate(uint face, uint pname, float* @params);
        [Require(MinVersion = "1.1")]
        private static readonly glMaterialfvDelegate glMaterialfv = null;

        public static void Materialfv(uint face, uint pname, float* @params) { glMaterialfv(face, pname, @params); }

        private delegate void glMaterialiDelegate(uint face, uint pname, int param);
        [Require(MinVersion = "1.1")]
        private static readonly glMaterialiDelegate glMateriali = null;

        public static void Materiali(uint face, uint pname, int param) { glMateriali(face, pname, param); }

        private delegate void glMaterialivDelegate(uint face, uint pname, int* @params);
        [Require(MinVersion = "1.1")]
        private static readonly glMaterialivDelegate glMaterialiv = null;

        public static void Materialiv(uint face, uint pname, int* @params) { glMaterialiv(face, pname, @params); }

        private delegate void glMatrixModeDelegate(uint mode);
        [Require(MinVersion = "1.1")]
        private static readonly glMatrixModeDelegate glMatrixMode = null;

        public static void MatrixMode(uint mode) { glMatrixMode(mode); }

        private delegate void glMultMatrixdDelegate(double* m);
        [Require(MinVersion = "1.1")]
        private static readonly glMultMatrixdDelegate glMultMatrixd = null;

        public static void MultMatrixd(double* m) { glMultMatrixd(m); }

        private delegate void glMultMatrixfDelegate(float* m);
        [Require(MinVersion = "1.1")]
        private static readonly glMultMatrixfDelegate glMultMatrixf = null;

        public static void MultMatrixf(float* m) { glMultMatrixf(m); }

        private delegate void glNewListDelegate(uint list, uint mode);
        [Require(MinVersion = "1.1")]
        private static readonly glNewListDelegate glNewList = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glNormal3bDelegate glNormal3b = null;

        public static void Normal3b(sbyte nx, sbyte ny, sbyte nz) { glNormal3b(nx, ny, nz); }

        private delegate void glNormal3bvDelegate(sbyte* v);
        [Require(MinVersion = "1.1")]
        private static readonly glNormal3bvDelegate glNormal3bv = null;

        public static void Normal3bv(sbyte* v) { glNormal3bv(v); }

        private delegate void glNormal3dDelegate(double nx, double ny, double nz);
        [Require(MinVersion = "1.1")]
        private static readonly glNormal3dDelegate glNormal3d = null;

        public static void Normal3d(double nx, double ny, double nz) { glNormal3d(nx, ny, nz); }

        private delegate void glNormal3dvDelegate(double* v);
        [Require(MinVersion = "1.1")]
        private static readonly glNormal3dvDelegate glNormal3dv = null;

        public static void Normal3dv(double* v) { glNormal3dv(v); }

        private delegate void glNormal3fDelegate(float nx, float ny, float nz);
        [Require(MinVersion = "1.1")]
        private static readonly glNormal3fDelegate glNormal3f = null;

        public static void Normal3f(float nx, float ny, float nz) { glNormal3f(nx, ny, nz); }

        private delegate void glNormal3fvDelegate(float* v);
        [Require(MinVersion = "1.1")]
        private static readonly glNormal3fvDelegate glNormal3fv = null;

        public static void Normal3fv(float* v) { glNormal3fv(v); }

        private delegate void glNormal3iDelegate(int nx, int ny, int nz);
        [Require(MinVersion = "1.1")]
        private static readonly glNormal3iDelegate glNormal3i = null;

        public static void Normal3i(int nx, int ny, int nz) { glNormal3i(nx, ny, nz); }

        private delegate void glNormal3ivDelegate(int* v);
        [Require(MinVersion = "1.1")]
        private static readonly glNormal3ivDelegate glNormal3iv = null;

        public static void Normal3iv(int* v) { glNormal3iv(v); }

        private delegate void glNormal3sDelegate(short nx, short ny, short nz);
        [Require(MinVersion = "1.1")]
        private static readonly glNormal3sDelegate glNormal3s = null;

        public static void Normal3s(short nx, short ny, short nz) { glNormal3s(nx, ny, nz); }

        private delegate void glNormal3svDelegate(short* v);
        [Require(MinVersion = "1.1")]
        private static readonly glNormal3svDelegate glNormal3sv = null;

        public static void Normal3sv(short* v) { glNormal3sv(v); }

        private delegate void glNormalPointerDelegate(uint type, int stride, void* pointer);
        [Require(MinVersion = "1.1")]
        private static readonly glNormalPointerDelegate glNormalPointer = null;

        public static void NormalPointer(uint type, int stride, void* pointer) { glNormalPointer(type, stride, pointer); }

        private delegate void glOrthoDelegate(double left, double right, double bottom, double top, double zNear, double zFar);
        [Require(MinVersion = "1.1")]
        private static readonly glOrthoDelegate glOrtho = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glPassThroughDelegate glPassThrough = null;

        public static void PassThrough(float token) { glPassThrough(token); }

        private delegate void glPixelMapfvDelegate(uint map, int mapsize, float* values);
        [Require(MinVersion = "1.1")]
        private static readonly glPixelMapfvDelegate glPixelMapfv = null;

        public static void PixelMapfv(uint map, int mapsize, float* values) { glPixelMapfv(map, mapsize, values); }

        private delegate void glPixelMapuivDelegate(uint map, int mapsize, uint* values);
        [Require(MinVersion = "1.1")]
        private static readonly glPixelMapuivDelegate glPixelMapuiv = null;

        public static void PixelMapuiv(uint map, int mapsize, uint* values) { glPixelMapuiv(map, mapsize, values); }

        private delegate void glPixelMapusvDelegate(uint map, int mapsize, ushort* values);
        [Require(MinVersion = "1.1")]
        private static readonly glPixelMapusvDelegate glPixelMapusv = null;

        public static void PixelMapusv(uint map, int mapsize, ushort* values) { glPixelMapusv(map, mapsize, values); }

        private delegate void glPixelStorefDelegate(uint pname, float param);
        [Require(MinVersion = "1.1")]
        private static readonly glPixelStorefDelegate glPixelStoref = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glPixelStoreiDelegate glPixelStorei = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glPixelTransferfDelegate glPixelTransferf = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glPixelTransferiDelegate glPixelTransferi = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glPixelZoomDelegate glPixelZoom = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glPointSizeDelegate glPointSize = null;

        public static void PointSize(float size) { glPointSize(size); }

        private delegate void glPolygonModeDelegate(uint face, uint mode);
        [Require(MinVersion = "1.1")]
        private static readonly glPolygonModeDelegate glPolygonMode = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glPolygonOffsetDelegate glPolygonOffset = null;

        public static void PolygonOffset(float factor, float units) { glPolygonOffset(factor, units); }

        private delegate void glPolygonStippleDelegate(byte* mask);
        [Require(MinVersion = "1.1")]
        private static readonly glPolygonStippleDelegate glPolygonStipple = null;

        public static void PolygonStipple(byte* mask) { glPolygonStipple(mask); }

        private delegate void glPopAttribDelegate();
        [Require(MinVersion = "1.1")]
        private static readonly glPopAttribDelegate glPopAttrib = null;

        public static void PopAttrib() { glPopAttrib(); }

        private delegate void glPopClientAttribDelegate();
        [Require(MinVersion = "1.1")]
        private static readonly glPopClientAttribDelegate glPopClientAttrib = null;

        public static void PopClientAttrib() { glPopClientAttrib(); }

        private delegate void glPopMatrixDelegate();
        [Require(MinVersion = "1.1")]
        private static readonly glPopMatrixDelegate glPopMatrix = null;

        public static void PopMatrix() { glPopMatrix(); }

        private delegate void glPopNameDelegate();
        [Require(MinVersion = "1.1")]
        private static readonly glPopNameDelegate glPopName = null;

        public static void PopName() { glPopName(); }

        private delegate void glPrioritizeTexturesDelegate(int n, uint* textures, float* priorities);
        [Require(MinVersion = "1.1")]
        private static readonly glPrioritizeTexturesDelegate glPrioritizeTextures = null;

        public static void PrioritizeTextures(int n, uint* textures, float* priorities) { glPrioritizeTextures(n, textures, priorities); }

        private delegate void glPushAttribDelegate(uint mask);
        [Require(MinVersion = "1.1")]
        private static readonly glPushAttribDelegate glPushAttrib = null;

        public static void PushAttrib(uint mask) { glPushAttrib(mask); }

        private delegate void glPushClientAttribDelegate(uint mask);
        [Require(MinVersion = "1.1")]
        private static readonly glPushClientAttribDelegate glPushClientAttrib = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glPushNameDelegate glPushName = null;

        public static void PushName(uint name) { glPushName(name); }

        private delegate void glRasterPos2dDelegate(double x, double y);
        [Require(MinVersion = "1.1")]
        private static readonly glRasterPos2dDelegate glRasterPos2d = null;

        public static void RasterPos2d(double x, double y) { glRasterPos2d(x, y); }

        private delegate void glRasterPos2dvDelegate(double* v);
        [Require(MinVersion = "1.1")]
        private static readonly glRasterPos2dvDelegate glRasterPos2dv = null;

        public static void RasterPos2dv(double* v) { glRasterPos2dv(v); }

        private delegate void glRasterPos2fDelegate(float x, float y);
        [Require(MinVersion = "1.1")]
        private static readonly glRasterPos2fDelegate glRasterPos2f = null;

        public static void RasterPos2f(float x, float y) { glRasterPos2f(x, y); }

        private delegate void glRasterPos2fvDelegate(float* v);
        [Require(MinVersion = "1.1")]
        private static readonly glRasterPos2fvDelegate glRasterPos2fv = null;

        public static void RasterPos2fv(float* v) { glRasterPos2fv(v); }

        private delegate void glRasterPos2iDelegate(int x, int y);
        [Require(MinVersion = "1.1")]
        private static readonly glRasterPos2iDelegate glRasterPos2i = null;

        public static void RasterPos2i(int x, int y) { glRasterPos2i(x, y); }

        private delegate void glRasterPos2ivDelegate(int* v);
        [Require(MinVersion = "1.1")]
        private static readonly glRasterPos2ivDelegate glRasterPos2iv = null;

        public static void RasterPos2iv(int* v) { glRasterPos2iv(v); }

        private delegate void glRasterPos2sDelegate(short x, short y);
        [Require(MinVersion = "1.1")]
        private static readonly glRasterPos2sDelegate glRasterPos2s = null;

        public static void RasterPos2s(short x, short y) { glRasterPos2s(x, y); }

        private delegate void glRasterPos2svDelegate(short* v);
        [Require(MinVersion = "1.1")]
        private static readonly glRasterPos2svDelegate glRasterPos2sv = null;

        public static void RasterPos2sv(short* v) { glRasterPos2sv(v); }

        private delegate void glRasterPos3dDelegate(double x, double y, double z);
        [Require(MinVersion = "1.1")]
        private static readonly glRasterPos3dDelegate glRasterPos3d = null;

        public static void RasterPos3d(double x, double y, double z) { glRasterPos3d(x, y, z); }

        private delegate void glRasterPos3dvDelegate(double* v);
        [Require(MinVersion = "1.1")]
        private static readonly glRasterPos3dvDelegate glRasterPos3dv = null;

        public static void RasterPos3dv(double* v) { glRasterPos3dv(v); }

        private delegate void glRasterPos3fDelegate(float x, float y, float z);
        [Require(MinVersion = "1.1")]
        private static readonly glRasterPos3fDelegate glRasterPos3f = null;

        public static void RasterPos3f(float x, float y, float z) { glRasterPos3f(x, y, z); }

        private delegate void glRasterPos3fvDelegate(float* v);
        [Require(MinVersion = "1.1")]
        private static readonly glRasterPos3fvDelegate glRasterPos3fv = null;

        public static void RasterPos3fv(float* v) { glRasterPos3fv(v); }

        private delegate void glRasterPos3iDelegate(int x, int y, int z);
        [Require(MinVersion = "1.1")]
        private static readonly glRasterPos3iDelegate glRasterPos3i = null;

        public static void RasterPos3i(int x, int y, int z) { glRasterPos3i(x, y, z); }

        private delegate void glRasterPos3ivDelegate(int* v);
        [Require(MinVersion = "1.1")]
        private static readonly glRasterPos3ivDelegate glRasterPos3iv = null;

        public static void RasterPos3iv(int* v) { glRasterPos3iv(v); }

        private delegate void glRasterPos3sDelegate(short x, short y, short z);
        [Require(MinVersion = "1.1")]
        private static readonly glRasterPos3sDelegate glRasterPos3s = null;

        public static void RasterPos3s(short x, short y, short z) { glRasterPos3s(x, y, z); }

        private delegate void glRasterPos3svDelegate(short* v);
        [Require(MinVersion = "1.1")]
        private static readonly glRasterPos3svDelegate glRasterPos3sv = null;

        public static void RasterPos3sv(short* v) { glRasterPos3sv(v); }

        private delegate void glRasterPos4dDelegate(double x, double y, double z, double w);
        [Require(MinVersion = "1.1")]
        private static readonly glRasterPos4dDelegate glRasterPos4d = null;

        public static void RasterPos4d(double x, double y, double z, double w) { glRasterPos4d(x, y, z, w); }

        private delegate void glRasterPos4dvDelegate(double* v);
        [Require(MinVersion = "1.1")]
        private static readonly glRasterPos4dvDelegate glRasterPos4dv = null;

        public static void RasterPos4dv(double* v) { glRasterPos4dv(v); }

        private delegate void glRasterPos4fDelegate(float x, float y, float z, float w);
        [Require(MinVersion = "1.1")]
        private static readonly glRasterPos4fDelegate glRasterPos4f = null;

        public static void RasterPos4f(float x, float y, float z, float w) { glRasterPos4f(x, y, z, w); }

        private delegate void glRasterPos4fvDelegate(float* v);
        [Require(MinVersion = "1.1")]
        private static readonly glRasterPos4fvDelegate glRasterPos4fv = null;

        public static void RasterPos4fv(float* v) { glRasterPos4fv(v); }

        private delegate void glRasterPos4iDelegate(int x, int y, int z, int w);
        [Require(MinVersion = "1.1")]
        private static readonly glRasterPos4iDelegate glRasterPos4i = null;

        public static void RasterPos4i(int x, int y, int z, int w) { glRasterPos4i(x, y, z, w); }

        private delegate void glRasterPos4ivDelegate(int* v);
        [Require(MinVersion = "1.1")]
        private static readonly glRasterPos4ivDelegate glRasterPos4iv = null;

        public static void RasterPos4iv(int* v) { glRasterPos4iv(v); }

        private delegate void glRasterPos4sDelegate(short x, short y, short z, short w);
        [Require(MinVersion = "1.1")]
        private static readonly glRasterPos4sDelegate glRasterPos4s = null;

        public static void RasterPos4s(short x, short y, short z, short w) { glRasterPos4s(x, y, z, w); }

        private delegate void glRasterPos4svDelegate(short* v);
        [Require(MinVersion = "1.1")]
        private static readonly glRasterPos4svDelegate glRasterPos4sv = null;

        public static void RasterPos4sv(short* v) { glRasterPos4sv(v); }

        private delegate void glReadBufferDelegate(uint mode);
        [Require(MinVersion = "1.1")]
        private static readonly glReadBufferDelegate glReadBuffer = null;

        public static void ReadBuffer(uint mode) { glReadBuffer(mode); }

        private delegate void glReadPixelsDelegate(int x, int y, int width, int height, uint format, uint type, void* pixels);
        [Require(MinVersion = "1.1")]
        private static readonly glReadPixelsDelegate glReadPixels = null;

        public static void ReadPixels(int x, int y, int width, int height, uint format, uint type, void* pixels) { glReadPixels(x, y, width, height, format, type, pixels); }

        private delegate void glRectdDelegate(double x1, double y1, double x2, double y2);
        [Require(MinVersion = "1.1")]
        private static readonly glRectdDelegate glRectd = null;

        public static void Rectd(double x1, double y1, double x2, double y2) { glRectd(x1, y1, x2, x2); }

        private delegate void glRectdvDelegate(double* v1, double* v2);
        [Require(MinVersion = "1.1")]
        private static readonly glRectdvDelegate glRectdv = null;

        public static void Rectdv(double* v1, double* v2) { glRectdv(v1, v2); }

        private delegate void glRectfDelegate(float x1, float y1, float x2, float y2);
        [Require(MinVersion = "1.1")]
        private static readonly glRectfDelegate glRectf = null;

        public static void Rectf(float x1, float y1, float x2, float y2) { glRectf(x1, y1, x2, y2); }

        private delegate void glRectfvDelegate(float* v1, float* v2);
        [Require(MinVersion = "1.1")]
        private static readonly glRectfvDelegate glRectfv = null;

        public static void Rectfv(float* v1, float* v2) { glRectfv(v1, v2); }

        private delegate void glRectiDelegate(int x1, int y1, int x2, int y2);
        [Require(MinVersion = "1.1")]
        private static readonly glRectiDelegate glRecti = null;

        public static void Recti(int x1, int y1, int x2, int y2) { glRecti(x1, y1, x2, y2); }

        private delegate void glRectivDelegate(int* v1, int* v2);
        [Require(MinVersion = "1.1")]
        private static readonly glRectivDelegate glRectiv = null;

        public static void Rectiv(int* v1, int* v2) { glRectiv(v1, v2); }

        private delegate void glRectsDelegate(short x1, short y1, short x2, short y2);
        [Require(MinVersion = "1.1")]
        private static readonly glRectsDelegate glRects = null;

        public static void Rects(short x1, short y1, short x2, short y2) { glRects(x1, y1, x2, y2); }

        private delegate void glRectsvDelegate(short* v1, short* v2);
        [Require(MinVersion = "1.1")]
        private static readonly glRectsvDelegate glRectsv = null;

        public static void Rectsv(short* v1, short* v2) { glRectsv(v1, v2); }

        private delegate int glRenderModeDelegate(uint mode);
        [Require(MinVersion = "1.1")]
        private static readonly glRenderModeDelegate glRenderMode = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glRotatedDelegate glRotated = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glRotatefDelegate glRotatef = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glScaledDelegate glScaled = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glScalefDelegate glScalef = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glScissorDelegate glScissor = null;

        public static void Scissor(int x, int y, int width, int height) { glScissor(x, y, width, height); }

        private delegate void glSelectBufferDelegate(int size, uint* buffer);
        [Require(MinVersion = "1.1")]
        private static readonly glSelectBufferDelegate glSelectBuffer = null;

        public static void SelectBuffer(int size, uint* buffer) { glSelectBuffer(size, buffer); }

        private delegate void glShadeModelDelegate(uint mode);
        [Require(MinVersion = "1.1")]
        private static readonly glShadeModelDelegate glShadeModel = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glStencilFuncDelegate glStencilFunc = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glStencilMaskDelegate glStencilMask = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glStencilOpDelegate glStencilOp = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glTexCoord1dDelegate glTexCoord1d = null;

        public static void TexCoord1d(double s) { glTexCoord1d(s); }

        private delegate void glTexCoord1dvDelegate(double* v);
        [Require(MinVersion = "1.1")]
        private static readonly glTexCoord1dvDelegate glTexCoord1dv = null;

        public static void TexCoord1dv(double* v) { glTexCoord1dv(v); }

        private delegate void glTexCoord1fDelegate(float s);
        [Require(MinVersion = "1.1")]
        private static readonly glTexCoord1fDelegate glTexCoord1f = null;

        public static void TexCoord1f(float s) { glTexCoord1f(s); }

        private delegate void glTexCoord1fvDelegate(float* v);
        [Require(MinVersion = "1.1")]
        private static readonly glTexCoord1fvDelegate glTexCoord1fv = null;

        public static void TexCoord1fv(float* v) { glTexCoord1fv(v); }

        private delegate void glTexCoord1iDelegate(int s);
        [Require(MinVersion = "1.1")]
        private static readonly glTexCoord1iDelegate glTexCoord1i = null;

        public static void TexCoord1i(int s) { glTexCoord1i(s); }

        private delegate void glTexCoord1ivDelegate(int* v);
        [Require(MinVersion = "1.1")]
        private static readonly glTexCoord1ivDelegate glTexCoord1iv = null;

        public static void TexCoord1iv(int* v) { glTexCoord1iv(v); }

        private delegate void glTexCoord1sDelegate(short s);
        [Require(MinVersion = "1.1")]
        private static readonly glTexCoord1sDelegate glTexCoord1s = null;

        public static void TexCoord1s(short s) { glTexCoord1s(s); }

        private delegate void glTexCoord1svDelegate(short* v);
        [Require(MinVersion = "1.1")]
        private static readonly glTexCoord1svDelegate glTexCoord1sv = null;

        public static void TexCoord1sv(short* v) { glTexCoord1sv(v); }

        private delegate void glTexCoord2dDelegate(double s, double t);
        [Require(MinVersion = "1.1")]
        private static readonly glTexCoord2dDelegate glTexCoord2d = null;

        public static void TexCoord2d(double s, double t) { glTexCoord2d(s, t); }

        private delegate void glTexCoord2dvDelegate(double* v);
        [Require(MinVersion = "1.1")]
        private static readonly glTexCoord2dvDelegate glTexCoord2dv = null;

        public static void TexCoord2dv(double* v) { glTexCoord2dv(v); }

        private delegate void glTexCoord2fDelegate(float s, float t);
        [Require(MinVersion = "1.1")]
        private static readonly glTexCoord2fDelegate glTexCoord2f = null;

        public static void TexCoord2f(float s, float t) { glTexCoord2f(s, t); }

        private delegate void glTexCoord2fvDelegate(float* v);
        [Require(MinVersion = "1.1")]
        private static readonly glTexCoord2fvDelegate glTexCoord2fv = null;

        public static void TexCoord2fv(float* v) { glTexCoord2fv(v); }

        private delegate void glTexCoord2iDelegate(int s, int t);
        [Require(MinVersion = "1.1")]
        private static readonly glTexCoord2iDelegate glTexCoord2i = null;

        public static void TexCoord2i(int s, int t) { glTexCoord2i(s, t); }

        private delegate void glTexCoord2ivDelegate(int* v);
        [Require(MinVersion = "1.1")]
        private static readonly glTexCoord2ivDelegate glTexCoord2iv = null;

        public static void TexCoord2iv(int* v) { glTexCoord2iv(v); }

        private delegate void glTexCoord2sDelegate(short s, short t);
        [Require(MinVersion = "1.1")]
        private static readonly glTexCoord2sDelegate glTexCoord2s = null;

        public static void TexCoord2s(short s, short t) { glTexCoord2s(s, t); }

        private delegate void glTexCoord2svDelegate(short* v);
        [Require(MinVersion = "1.1")]
        private static readonly glTexCoord2svDelegate glTexCoord2sv = null;

        public static void TexCoord2sv(short* v) { glTexCoord2sv(v); }

        private delegate void glTexCoord3dDelegate(double s, double t, double r);
        [Require(MinVersion = "1.1")]
        private static readonly glTexCoord3dDelegate glTexCoord3d = null;

        public static void TexCoord3d(double s, double t, double r) { glTexCoord3d(s, t, r); }

        private delegate void glTexCoord3dvDelegate(double* v);
        [Require(MinVersion = "1.1")]
        private static readonly glTexCoord3dvDelegate glTexCoord3dv = null;

        public static void TexCoord3dv(double* v) { glTexCoord3dv(v); }

        private delegate void glTexCoord3fDelegate(float s, float t, float r);
        [Require(MinVersion = "1.1")]
        private static readonly glTexCoord3fDelegate glTexCoord3f = null;

        public static void TexCoord3f(float s, float t, float r) { glTexCoord3f(s, t, r); }

        private delegate void glTexCoord3fvDelegate(float* v);
        [Require(MinVersion = "1.1")]
        private static readonly glTexCoord3fvDelegate glTexCoord3fv = null;

        public static void TexCoord3fv(float* v) { glTexCoord3fv(v); }

        private delegate void glTexCoord3iDelegate(int s, int t, int r);
        [Require(MinVersion = "1.1")]
        private static readonly glTexCoord3iDelegate glTexCoord3i = null;

        public static void TexCoord3i(int s, int t, int r) { glTexCoord3i(s, t, r); }

        private delegate void glTexCoord3ivDelegate(int* v);
        [Require(MinVersion = "1.1")]
        private static readonly glTexCoord3ivDelegate glTexCoord3iv = null;

        public static void TexCoord3iv(int* v) { glTexCoord3iv(v); }

        private delegate void glTexCoord3sDelegate(short s, short t, short r);
        [Require(MinVersion = "1.1")]
        private static readonly glTexCoord3sDelegate glTexCoord3s = null;

        public static void TexCoord3s(short s, short t, short r) { glTexCoord3s(s, t, r); }

        private delegate void glTexCoord3svDelegate(short* v);
        [Require(MinVersion = "1.1")]
        private static readonly glTexCoord3svDelegate glTexCoord3sv = null;

        public static void TexCoord3sv(short* v) { glTexCoord3sv(v); }

        private delegate void glTexCoord4dDelegate(double s, double t, double r, double q);
        [Require(MinVersion = "1.1")]
        private static readonly glTexCoord4dDelegate glTexCoord4d = null;

        public static void TexCoord4d(double s, double t, double r, double q) { glTexCoord4d(s, t, r, q); }

        private delegate void glTexCoord4dvDelegate(double* v);
        [Require(MinVersion = "1.1")]
        private static readonly glTexCoord4dvDelegate glTexCoord4dv = null;

        public static void TexCoord4dv(double* v) { glTexCoord4dv(v); }

        private delegate void glTexCoord4fDelegate(float s, float t, float r, float q);
        [Require(MinVersion = "1.1")]
        private static readonly glTexCoord4fDelegate glTexCoord4f = null;

        public static void TexCoord4f(float s, float t, float r, float q) { glTexCoord4f(s, t, r, q); }

        private delegate void glTexCoord4fvDelegate(float* v);
        [Require(MinVersion = "1.1")]
        private static readonly glTexCoord4fvDelegate glTexCoord4fv = null;

        public static void TexCoord4fv(float* v) { glTexCoord4fv(v); }

        private delegate void glTexCoord4iDelegate(int s, int t, int r, int q);
        [Require(MinVersion = "1.1")]
        private static readonly glTexCoord4iDelegate glTexCoord4i = null;

        public static void TexCoord4i(int s, int t, int r, int q) { glTexCoord4i(s, t, r, q); }

        private delegate void glTexCoord4ivDelegate(int* v);
        [Require(MinVersion = "1.1")]
        private static readonly glTexCoord4ivDelegate glTexCoord4iv = null;

        public static void TexCoord4iv(int* v) { glTexCoord4iv(v); }

        private delegate void glTexCoord4sDelegate(short s, short t, short r, short q);
        [Require(MinVersion = "1.1")]
        private static readonly glTexCoord4sDelegate glTexCoord4s = null;

        public static void TexCoord4s(short s, short t, short r, short q) { glTexCoord4s(s, t, r, q); }

        private delegate void glTexCoord4svDelegate(short* v);
        [Require(MinVersion = "1.1")]
        private static readonly glTexCoord4svDelegate glTexCoord4sv = null;

        public static void TexCoord4sv(short* v) { glTexCoord4sv(v); }

        private delegate void glTexCoordPointerDelegate(int size, uint type, int stride, void* pointer);
        [Require(MinVersion = "1.1")]
        private static readonly glTexCoordPointerDelegate glTexCoordPointer = null;

        public static void TexCoordPointer(int size, uint type, int stride, void* pointer) { glTexCoordPointer(size, type, stride, pointer); }

        private delegate void glTexEnvfDelegate(uint target, uint pname, float param);
        [Require(MinVersion = "1.1")]
        private static readonly glTexEnvfDelegate glTexEnvf = null;

        public static void TexEnvf(uint target, uint pname, float param) { glTexEnvf(target, pname, param); }

        private delegate void glTexEnvfvDelegate(uint target, uint pname, float* @params);
        [Require(MinVersion = "1.1")]
        private static readonly glTexEnvfvDelegate glTexEnvfv = null;

        public static void TexEnvfv(uint target, uint pname, float* @params) { glTexEnvfv(target, pname, @params); }

        private delegate void glTexEnviDelegate(uint target, uint pname, int param);
        [Require(MinVersion = "1.1")]
        private static readonly glTexEnviDelegate glTexEnvi = null;

        public static void TexEnvi(uint target, uint pname, int param) { glTexEnvi(target, pname, param); }

        private delegate void glTexEnvivDelegate(uint target, uint pname, int* @params);
        [Require(MinVersion = "1.1")]
        private static readonly glTexEnvivDelegate glTexEnviv = null;

        public static void TexEnviv(uint target, uint pname, int* @params) { glTexEnviv(target, pname, @params); }

        private delegate void glTexGendDelegate(uint coord, uint pname, double param);
        [Require(MinVersion = "1.1")]
        private static readonly glTexGendDelegate glTexGend = null;

        public static void TexGend(uint coord, uint pname, double param) { glTexGend(coord, pname, param); }

        private delegate void glTexGendvDelegate(uint coord, uint pname, double* @params);
        [Require(MinVersion = "1.1")]
        private static readonly glTexGendvDelegate glTexGendv = null;

        public static void TexGendv(uint coord, uint pname, double* @params) { glTexGendv(coord, pname, @params); }

        private delegate void glTexGenfDelegate(uint coord, uint pname, float param);
        [Require(MinVersion = "1.1")]
        private static readonly glTexGenfDelegate glTexGenf = null;

        public static void TexGenf(uint coord, uint pname, float param) { glTexGenf(coord, pname, param); }

        private delegate void glTexGenfvDelegate(uint coord, uint pname, float* @params);
        [Require(MinVersion = "1.1")]
        private static readonly glTexGenfvDelegate glTexGenfv = null;

        public static void TexGenfv(uint coord, uint pname, float* @params) { glTexGenfv(coord, pname, @params); }

        private delegate void glTexGeniDelegate(uint coord, uint pname, int param);
        [Require(MinVersion = "1.1")]
        private static readonly glTexGeniDelegate glTexGeni = null;

        public static void TexGeni(uint coord, uint pname, int param) { glTexGeni(coord, pname, param); }

        private delegate void glTexGenivDelegate(uint coord, uint pname, int* @params);
        [Require(MinVersion = "1.1")]
        private static readonly glTexGenivDelegate glTexGeniv = null;

        public static void TexGeniv(uint coord, uint pname, int* @params) { glTexGeniv(coord, pname, @params); }

        private delegate void glTexImage1DDelegate(uint target, int level, int internalformat, int width, int border, uint format, uint type, void* pixels);
        [Require(MinVersion = "1.1")]
        private static readonly glTexImage1DDelegate glTexImage1D = null;

        public static void TexImage1D(uint target, int level, int internalformat, int width, int border, uint format, uint type, void* pixels) { glTexImage1D(target, level, internalformat, width, border, format, type, pixels); }

        private delegate void glTexImage2DDelegate(uint target, int level, int internalformat, int width, int height, int border, uint format, uint type, void* pixels);
        [Require(MinVersion = "1.1")]
        private static readonly glTexImage2DDelegate glTexImage2D = null;

        public static void TexImage2D(uint target, int level, int internalformat, int width, int height, int border, uint format, uint type, void* pixels) { glTexImage2D(target, level, internalformat, width, height, border, format, type, pixels); }

        private delegate void glTexParameterfDelegate(uint target, uint pname, float param);
        [Require(MinVersion = "1.1")]
        private static readonly glTexParameterfDelegate glTexParameterf = null;

        public static void TexParameterf(uint target, uint pname, float param) { glTexParameterf(target, pname, param); }

        private delegate void glTexParameterfvDelegate(uint target, uint pname, float* @params);
        [Require(MinVersion = "1.1")]
        private static readonly glTexParameterfvDelegate glTexParameterfv = null;

        public static void TexParameterfv(uint target, uint pname, float* @params) { glTexParameterfv(target, pname, @params); }

        private delegate void glTexParameteriDelegate(uint target, uint pname, int param);
        [Require(MinVersion = "1.1")]
        private static readonly glTexParameteriDelegate glTexParameteri = null;

        public static void TexParameteri(uint target, uint pname, int param) { glTexParameteri(target, pname, param); }

        private delegate void glTexParameterivDelegate(uint target, uint pname, int* @params);
        [Require(MinVersion = "1.1")]
        private static readonly glTexParameterivDelegate glTexParameteriv = null;

        public static void TexParameteriv(uint target, uint pname, int* @params) { glTexParameteriv(target, pname, @params); }

        private delegate void glTexSubImage1DDelegate(uint target, int level, int xoffset, int width, uint format, uint type, void* pixels);
        [Require(MinVersion = "1.1")]
        private static readonly glTexSubImage1DDelegate glTexSubImage1D = null;

        public static void TexSubImage1D(uint target, int level, int xoffset, int width, uint format, uint type, void* pixels) { glTexSubImage1D(target, level, xoffset, width, format, type, pixels); }

        private delegate void glTexSubImage2DDelegate(uint target, int level, int xoffset, int yoffset, int width, int height, uint format, uint type, void* pixels);
        [Require(MinVersion = "1.1")]
        private static readonly glTexSubImage2DDelegate glTexSubImage2D = null;

        public static void TexSubImage2D(uint target, int level, int xoffset, int yoffset, int width, int height, uint format, uint type, void* pixels) { glTexSubImage2D(target, level, xoffset, yoffset, width, height, format, type, pixels); }

        private delegate void glTranslatedDelegate(double x, double y, double z);
        [Require(MinVersion = "1.1")]
        private static readonly glTranslatedDelegate glTranslated = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glTranslatefDelegate glTranslatef = null;
        ...
        [Require(MinVersion = "1.1")]
        private static readonly glVertex2dDelegate glVertex2d = null;

        public static void Vertex2d(double x, double y) { glVertex2d(x, y); }

        private delegate void glVertex2dvDelegate(double* v);
        [Require(MinVersion = "1.1")]
        private static readonly glVertex2dvDelegate glVertex2dv = null;

        public static void Vertex2dv(double* v) { glVertex2dv(v); }

        private delegate void glVertex2fDelegate(float x, float y);
        [Require(MinVersion = "1.1")]
        private static readonly glVertex2fDelegate glVertex2f = null;

        public static void Vertex2f(float x, float y) { glVertex2f(x, y); }

        private delegate void glVertex2fvDelegate(float* v);
        [Require(MinVersion = "1.1")]
        private static readonly glVertex2fvDelegate glVertex2fv = null;

        public static void Vertex2fv(float* v) { glVertex2fv(v); }

        private delegate void glVertex2iDelegate(int x, int y);
        [Require(MinVersion = "1.1")]
        private static readonly glVertex2iDelegate glVertex2i = null;

        public static void Vertex2i(int x, int y) { glVertex2i(x, y); }

        private delegate void glVertex2ivDelegate(int* v);
        [Require(MinVersion = "1.1")]
        private static readonly glVertex2ivDelegate glVertex2iv = null;

        public static void Vertex2iv(int* v) { glVertex2iv(v); }

        private delegate void glVertex2sDelegate(short x, short y);
        [Require(MinVersion = "1.1")]
        private static readonly glVertex2sDelegate glVertex2s = null;

        public static void Vertex2s(short x, short y) { glVertex2s(x, y); }

        private delegate void glVertex2svDelegate(short* v);
        [Require(MinVersion = "1.1")]
        private static readonly glVertex2svDelegate glVertex2sv = null;

        public static void Vertex2sv(short* v) { glVertex2sv(v); }

        private delegate void glVertex3dDelegate(double x, double y, double z);
        [Require(MinVersion = "1.1")]
        private static readonly glVertex3dDelegate glVertex3d = null;

        public static void Vertex3d(double x, double y, double z) { glVertex3d(x, y, z); }

        private delegate void glVertex3dvDelegate(double* v);
        [Require(MinVersion = "1.1")]
        private static readonly glVertex3dvDelegate glVertex3dv = null;

        public static void Vertex3dv(double* v) { glVertex3dv(v); }

        private delegate void glVertex3fDelegate(float x, float y, float z);
        [Require(MinVersion = "1.1")]
        private static readonly glVertex3fDelegate glVertex3f = null;

        public static void Vertex3f(float x, float y, float z) { glVertex3f(x, y, z); }

        private delegate void glVertex3fvDelegate(float* v);
        [Require(MinVersion = "1.1")]
        private static readonly glVertex3fvDelegate glVertex3fv = null;

        public static void Vertex3fv(float* v) { glVertex3fv(v); }

        private delegate void glVertex3iDelegate(int x, int y, int z);
        [Require(MinVersion = "1.1")]
        private static readonly glVertex3iDelegate glVertex3i = null;

        public static void Vertex3i(int x, int y, int z) { glVertex3i(x, y, z); }

        private delegate void glVertex3ivDelegate(int* v);
        [Require(MinVersion = "1.1")]
        private static readonly glVertex3ivDelegate glVertex3iv = null;

        public static void Vertex3iv(int* v) { glVertex3iv(v); }

        private delegate void glVertex3sDelegate(short x, short y, short z);
        [Require(MinVersion = "1.1")]
        private static readonly glVertex3sDelegate glVertex3s = null;

        public static void Vertex3s(short x, short y, short z) { glVertex3s(x, y, z); }

        private delegate void glVertex3svDelegate(short* v);
        [Require(MinVersion = "1.1")]
        private static readonly glVertex3svDelegate glVertex3sv = null;

        public static void Vertex3sv(short* v) { glVertex3sv(v); }

        private delegate void glVertex4dDelegate(double x, double y, double z, double w);
        [Require(MinVersion = "1.1")]
        private static readonly glVertex4dDelegate glVertex4d = null;

        public static void Vertex4d(double x, double y, double z, double w) { glVertex4d(x, y, z, w); }

        private delegate void glVertex4dvDelegate(double* v);
        [Require(MinVersion = "1.1")]
        private static readonly glVertex4dvDelegate glVertex4dv = null;

        public static void Vertex4dv(double* v) { glVertex4dv(v); }

        private delegate void glVertex4fDelegate(float x, float y, float z, float w);
        [Require(MinVersion = "1.1")]
        private static readonly glVertex4fDelegate glVertex4f = null;

        public static void Vertex4f(float x, float y, float z, float w) { glVertex4f(x, y, z, w); }

        private delegate void glVertex4fvDelegate(float* v);
        [Require(MinVersion = "1.1")]
        private static readonly glVertex4fvDelegate glVertex4fv = null;

        public static void Vertex4fv(float* v) { glVertex4fv(v); }

        private delegate void glVertex4iDelegate(int x, int y, int z, int w);
        [Require(MinVersion = "1.1")]
        private static readonly glVertex4iDelegate glVertex4i = null;

        public static void Vertex4i(int x, int y, int z, int w) { glVertex4i(x, y, z, w); }

        private delegate void glVertex4ivDelegate(int* v);
        [Require(MinVersion = "1.1")]
        private static readonly glVertex4ivDelegate glVertex4iv = null;

        public static void Vertex4iv(int* v) { glVertex4iv(v); }

        private delegate void glVertex4sDelegate(short x, short y, short z, short w);
        [Require(MinVersion = "1.1")]
        private static readonly glVertex4sDelegate glVertex4s = null;

        public static void Vertex4s(short x, short y, short z, short w) { glVertex4s(x, y, z, w); }

        private delegate void glVertex4svDelegate(short* v);
        [Require(MinVersion = "1.1")]
        private static readonly glVertex4svDelegate glVertex4sv = null;

        public static void Vertex4sv(short* v) { glVertex4sv(v); }

        private delegate void glVertexPointerDelegate(int size, uint type, int stride, void* pointer);
        [Require(MinVersion = "1.1")]
        private static readonly glVertexPointerDelegate glVertexPointer = null;

        public static void VertexPointer(int size, uint type, int stride, void* pointer) { glVertexPointer(size, type, stride, pointer); }

        private delegate void glViewportDelegate(int x, int y, int width, int height);
        [Require(MinVersion = "1.1")]
        private static readonly glViewportDelegate glViewport = null;
