...
namespace TwistedLogik.Ultraviolet.Layout.Elements
{
    ...
    public struct Sourced<T> : IEquatable<Sourced<T>> where T : struct, IEquatable<T>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Sourced{T}"/> structure.
        /// </summary>
        ...
        public Sourced(T value, AssetSource source)
        {
            this.value  = value;
            this.source = source;
        }
        ...
        /// </summary>
        /// <param name="sourced">The <see cref="Sourced{T}"/> to convert.</param>
        /// <returns>The underlying value of the sourced asset.</returns>
        public static implicit operator T(Sourced<T> sourced)
        {
        ...
        /// </summary>
        /// <param name="id1">The first <see cref="Sourced{T}"/> to compare.</param>
        /// <param name="id2">The second <see cref="Sourced{T}"/> to compare.</param>
        /// <returns><c>true</c> if the specified sourced assets are equal; otherwise, <c>false</c>.</returns>
        public static Boolean operator ==(Sourced<T> id1, Sourced<T> id2)
        {
        ...
        /// <summary>
        /// Parses a string into an instance of <see cref="Sourced{T}"/>.
        /// </summary>
        /// <param name="str">The string to parse.</param>
        /// <returns>The <see cref="Sourced{T}"/> instance that was created from the specified string.</returns>
        public static Sourced<T> Parse(String str)
        {
        ...
        /// <returns>The <see cref="Sourced{T}"/> instance that was created from the specified string.</returns>
        public static Sourced<T> Parse(String str, IFormatProvider provider)
        {
            ...
            return new Sourced<T>(underlyingValue, source);
        }
        ...
        {
            return obj is Sourced<T> && Equals((Sourced<T>)obj);
        }

        /// <inheritdoc/>
        public Boolean Equals(Sourced<T> other)
        {
            return
