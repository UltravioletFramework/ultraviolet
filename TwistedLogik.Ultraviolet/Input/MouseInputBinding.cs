...
namespace TwistedLogik.Ultraviolet.Input
{
    ...
    public sealed class MouseInputBinding : InputBinding
    {
        ...
        /// <summary>
        /// Initializes a new instance of the MouseInputBinding class.
        /// </summary>
        /// <param name="mouse">The keyboard device with which this binding is associated.</param>
        /// <param name="button">The binding's primary key.</param>
        ...
        /// <summary>
        /// Gets the mouse device that created this input binding.
        /// </summary>
        ...
        /// <summary>
        /// Gets the binding's primary button.
        /// </summary>
