...
namespace TwistedLogik.Ultraviolet
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the Vector4 structure with all of its components set to the specified value.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the Vector4 structure with its x and y components set to the 
        ...
        /// <summary>
        /// Initializes a new instance of the Vector4 structure with its x, y, and z components set to the 
        ...
        /// <returns>true if the specified vectors are equal; otherwise, false.</returns>
        ...
        /// <param name="vector1">The first vector to compare.</param>
        /// <param name="vector2">The second vector to compare.</param>
        /// <returns>true if the specified vectors are unequal; otherwise, false.</returns>
        public static Boolean operator !=(Vector4 vector1, Vector4 vector2)
        {
            return !vector1.Equals(vector2);
        }
        ...
        /// <summary>
        /// Converts the string representation of a vector into an instance of the Vector4 structure.
        ...
        /// </summary>
        /// <param name="s">A string containing a vector to convert.</param>
        /// <returns>A instance of the Vector4 structure equivalent to the vector contained in <paramref name="s"/>.</returns>
