...
namespace TwistedLogik.Ultraviolet.UI.Presentation
{
    partial class DrawingContext
    {
        ...
        private static readonly UltravioletSingleton<Texture2D> StencilTexture = new UltravioletSingleton<Texture2D>(uv =>
        {
        ...
        private static readonly UltravioletSingleton<DepthStencilState> StencilWriteDepthState = new UltravioletSingleton<DepthStencilState>(uv =>
        {
        ...
        private static readonly UltravioletSingleton<DepthStencilState> StencilReadDepthState = new UltravioletSingleton<DepthStencilState>(uv =>
        {
            var state = DepthStencilState.Create();
            state.StencilEnable = true;
        ...
        private static readonly UltravioletSingleton<BlendState> StencilBlendState = new UltravioletSingleton<BlendState>(uv =>
        {
