...
namespace TwistedLogik.Ultraviolet.UI.Presentation.Elements
{
    ...
    /// </summary>
    [UvmlKnownType(null, "TwistedLogik.Ultraviolet.UI.Presentation.Elements.Templates.HScrollTrack.xml")]
    public class HScrollTrack : ScrollTrackBase
    {
        ...
        /// <summary>
        /// Handles the <see cref="Mouse.PreviewMouseMoveEvent"/> event for the Thumb button.
        /// </summary>
        ...
        /// <summary>
        /// Handles the <see cref="Mouse.PreviewMouseDownEvent"/> event for the Thumb button.
        /// </summary>
